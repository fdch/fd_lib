...
//
/////////////////////////////////////////////////////////
#include "pix_phase2.h"
#include "Utils/Functions.h"//for CLAMP
#include <cmath>
#define FFTWPLANNERFLAG FFTW_ESTIMATE
#define DEF 64

CPPEXTERN_NEW_WITH_ONE_ARG(pix_phase2, t_floatarg, A_DEFFLOAT);
/////////////////////////////////////////////////////////
//
// pix_phase2
//
...
//
/////////////////////////////////////////////////////////
pix_phase2 :: pix_phase2(t_floatarg n):
...
//
/////////////////////////////////////////////////////////
void pix_phase2 :: reallocAll(int n, int m)
{
  m_enable=false;
// Get new sizes
  m_xsize = n;
...
void pix_phase2 :: copyRect(unsigned char*s,unsigned char *t,bool dir,bool Yoff, bool Xoff)
{
// copyRect: 
...
void pix_phase2 :: shiftFFT(unsigned char*data)
{
  //original
...
void pix_phase2 :: phaseSpec(unsigned char *data, fftwf_complex *fft)
{
  float ph;
  long i,j, k=0,step;
//calculate phase and normalize
  for(i=0;i<m_ysize;i++)
    for(j=0;j<m_xsize/2+1;j++) {
      step=i*m_ysize+j;
      ph = atan2(fft[k][0], fft[k][1]);
      data[step] = CLAMP(logf(1.+ph)*m_xsize/2);
      k++;
  }
...
//
/////////////////////////////////////////////////////////
void pix_phase2 :: processGrayImage(imageStruct &image)
{
...
//
/////////////////////////////////////////////////////////
void pix_phase2 :: obj_setupCallback(t_class *classPtr) {}