...
typedef struct scroll {
  ...
  t_float
      x_norm; // flag to user normalized coordinates (1) or not (0) (default=0)
} t_scroll;
...
void scroll_setup() {
  ...
  class_addmethod(scroll_class, (t_method)scroll_ymoveto, gensym("ypos"),
                  A_FLOAT, 0);
  class_addmethod(scroll_class, (t_method)scroll_page, gensym("page"), A_FLOAT,
                  0);
  class_addmethod(scroll_class, (t_method)scroll_norm, gensym("norm"), A_FLOAT,
                  0);
  class_addmethod(scroll_class, (t_method)scroll_get_screenx, gensym("screenx"),
                  A_FLOAT, 0);
  class_addmethod(scroll_class, (t_method)scroll_get_screeny, gensym("screeny"),
                  A_FLOAT, 0);
}
