...
[mandelbrot] runs the equations for the mandelbrot system as in
(https://en.wikipedia.org/wiki/mandelbrot_system) developed by Fede Camara Halac
(fch226@nyu.edu)
...
{
    mandelbrot_class =
        class_new(gensym("mandelbrot"), (t_newmethod)mandelbrot_new, 0,
                  sizeof(t_mandelbrot), 0, A_NULL);
