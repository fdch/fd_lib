...
static void clifford_a(t_clifford *x, t_floatarg f) { x->inita = f; }

static void clifford_b(t_clifford *x, t_floatarg f) { x->initb = f; }

static void clifford_c(t_clifford *x, t_floatarg f) { x->initc = f; }

static void clifford_d(t_clifford *x, t_floatarg f) { x->initd = f; }

static void clifford_x(t_clifford *x, t_floatarg f) { x->x = f; }

static void clifford_y(t_clifford *x, t_floatarg f) { x->y = f; }

static void clifford_maxval(t_clifford *x, t_floatarg f) { x->gmax = f; }
...
void clifford_setup(void)
{
    ...
    class_addmethod(clifford_class, (t_method)clifford_a, gensym("a"), A_FLOAT,
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_b, gensym("b"), A_FLOAT,
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_c, gensym("c"), A_FLOAT,
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_d, gensym("d"), A_FLOAT,
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_reset, gensym("reset"),
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_x, gensym("x"), A_FLOAT,
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_y, gensym("y"), A_FLOAT,
                    A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_maxval, gensym("maxval"),
                    A_FLOAT, A_NULL);
    class_addmethod(clifford_class, (t_method)clifford_print, gensym("print"),
                    A_FLOAT, A_NULL);
}
