...
static void parabola_a(t_parabola *x, t_floatarg f) { x->a = f; }
static void parabola_x(t_parabola *x, t_floatarg f) { x->x = f; }
...
void parabola_setup(void)
{
    parabola_class =
        class_new(gensym("parabola"), (t_newmethod)parabola_new, 0,
                  sizeof(t_parabola), CLASS_DEFAULT, A_DEFFLOAT, 0);
    class_addbang(parabola_class, parabola_bang);
    class_addfloat(parabola_class, parabola_float);
    class_addmethod(parabola_class, (t_method)parabola_a, gensym("a"), A_FLOAT,
                    A_NULL);
