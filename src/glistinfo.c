...
char vars[][SLEN + 1] = {"gl_valid",    "gl_pixwidth",   "gl_pixheight",
                         "gl_x1",       "gl_y1",         "gl_x2",
                         "gl_y2",       "gl_screenx1",   "gl_screeny1",
                         "gl_screenx2", "gl_screeny2",   "gl_xmargin",
                         "gl_ymargin",  "gl_nxlabels",   "gl_xlabely",
                         "gl_nylabels", "gl_ylabelx",    "gl_font",
                         "gl_zoom",     "gl_havewindow", "gl_mapped",
                         "gl_dirty",    "gl_loading",    "gl_willvis",
                         "gl_edit",     "gl_isdeleting", "gl_goprect",
                         "gl_isgraph",  "gl_hidetext",   "gl_private",
                         "gl_isclone",  "gl_name",       "gl_owner",
                         "\0"};
...
{
    glistinfo_class =
        class_new(gensym("glistinfo"), (t_newmethod)glistinfo_new, 0,
                  sizeof(t_glistinfo), CLASS_DEFAULT, A_DEFSYM, A_NULL);

    class_addbang(glistinfo_class, glistinfo_bang);
    class_addmethod(glistinfo_class, (t_method)glistinfo_dump, gensym("dump"),
                    A_NULL);
}
