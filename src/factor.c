...
void factor_setup()
{
  factor_class = class_new(gensym("factor"), (t_newmethod)factor_new, 0,
                           sizeof(t_factor), CLASS_DEFAULT, A_DEFFLOAT, A_NULL);
  class_addcreator((t_newmethod)factor_new, gensym("n!"),
                   A_DEFFLOAT, A_NULL);
