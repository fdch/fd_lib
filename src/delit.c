...
{
  delit_class = class_new(gensym("delit"), (t_newmethod)delit_new,
                          (t_method)delit_free, sizeof(t_delit), 0,
  ...
  class_addmethod(delit_class, (t_method)delit_set,
    gensym("set"), A_DEFFLOAT, A_DEFFLOAT, A_NULL);
  class_addmethod(delit_class, (t_method)delit_reset,
    gensym("reset"), A_NULL);
  class_addmethod(delit_class, (t_method)delit_stop,
    gensym("stop"), A_NULL);
}
